...
// See docs/specs/08-adapter-extension-points.md §3.8
//
...
// all workflow starts). A replacement `RbacWorkflowAuthorizationHook` validates the actor's role on the project.
//
